...
```
batdongsan <command> [arguments] [flags]
```

Run `batdongsan <command> --help` for the full flag list on any command. This
...
per operation you declare in `batdongsan/domain.go`.
